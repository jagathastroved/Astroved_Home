            ...
            >
              ...
              <div className="pt-2 md:pt-4 flex flex-col sm:flex-row items-center sm:items-start gap-4">
                ...
                {currentBanner.secondaryButtonText && (
                  <button className="px-6 py-3 md:px-8 md:py-4 rounded-full border border-white/30 text-white font-sans text-xs md:text-sm tracking-widest uppercase font-bold hover:bg-white/10 active:scale-95 transition-all">
                    {currentBanner.secondaryButtonText}
                  </button>
                )}
              </div>
