            ...
            <AnimatePresence initial={false} custom={direction}>
              ...
              >
                ...
                <div className="w-full relative">
                  ...
                  <div className="flex absolute bottom-0 inset-x-0 pb-12 md:pb-0 md:inset-y-0 md:inset-x-auto md:right-0 w-full md:w-[55%] flex-col justify-end md:justify-center items-center text-center px-4 md:px-6 lg:px-12 z-10 group/text">
                    <motion.span
                      initial={{ opacity: 0, y: 15 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.2, duration: 0.5 }}
                      className={`font-serif text-xs md:text-xs lg:text-base xl:text-lg mb-1 md:mb-1 lg:mb-2 ${events[currentIndex].taglineColor} drop-shadow-md`}
                    >
                    ...
                    <motion.p
                      ...
                      className={`font-sans text-[10px] sm:text-xs md:text-[10px] lg:text-sm mb-3 md:mb-2 lg:mb-5 font-semibold tracking-wide ${events[currentIndex].deadlineColor} drop-shadow-md`}
                    >
                    ...
                    <motion.button
                      ...
                      className={`relative overflow-hidden inline-flex items-center justify-center px-5 py-2 md:px-4 md:py-1.5 lg:px-6 lg:py-2.5 rounded-full font-sans text-xs md:text-[10px] lg:text-sm font-extrabold transition-all shadow-[0_0_15px_rgba(0,0,0,0.3)] ${events[currentIndex].buttonBg} ${events[currentIndex].buttonText} border border-white/20`}
                    >
          ...
          <div className="w-11/12 max-w-4xl mx-auto relative group">
            ...
            >
              ...
              <div className="text-center lg:text-left z-10 px-2">
                ...
                <p className="text-xs md:text-sm font-medium text-amber-100/90 dark:text-white/90 mt-0.5 tracking-wide">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 w-full lg:w-auto z-10">
                ...
                {/* Amber Button */}
                <button className="animated-btn flex-1 sm:flex-none flex items-center justify-center gap-1.5 bg-gradient-to-r from-amber-500 to-orange-500 text-red-950 px-5 py-2.5 rounded-full font-bold text-xs md:text-sm hover:from-amber-400 hover:to-orange-400 transition-all shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_25px_rgba(245,158,11,0.5)] transform hover:-translate-y-0.5 border border-amber-300/50">
